...
- 모바일 `medium/close/reaction`은 화면 상단이 아니라 인물 수에 맞춘 하단 카메라 원점에서 확대합니다. 1인은 55%, 2인은 80%, 3인은 92%를 사용해 폭이 좁은 전신 원화도 확대할수록 얼굴과 상체가 대사창 위로 올라옵니다. PC 원점은 그대로 분리되어 모바일 보정의 영향을 받지 않습니다.
