...
역사극 채널·조건부 선택·다중 실패/엔딩 샘플은 `public/game-list/deokman-v8-preview/`를 참고합니다. 단일 챕터에서 `dialogue/narration/record/system`, 상태·인벤토리 기반 `when`, 4개 `gameOver`, 3개 챕터 엔딩을 함께 사용합니다.
...
- `docs/DEOKMAN_V8_GAME_BIBLE.ko.md`
- 샘플 YAML: `public/game-list/conan/*.yaml`
- 역사극 분기 샘플: `public/game-list/deokman-v8-preview/*.yaml`
...
- 2026-08-18: 구버전 8장 덕만 게임과 전용 문서·회귀 테스트를 제거하고, V8 수직 슬라이스가 필요한 배경·인물·아이템을 `public/game-list/deokman-v8-preview/assets/` 아래에 독립적으로 보유하도록 이관했습니다. 게임 목록·사이트맵·README 샘플도 V8 한 작품만 가리키며, 시작·엔딩 화면은 `root:/` 자산 경로를 사용합니다.
